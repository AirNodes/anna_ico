...
module.exports = function(deployer, network, accounts) {
  ...
  const endBlock = startBlock + 236330 // (93 * 24 * 3600 / 34)  // blockchain block number where it will end. A block is more or less 30s, https://etherscan.io/chart/blocktime
